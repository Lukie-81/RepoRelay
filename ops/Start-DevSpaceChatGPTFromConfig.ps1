[CmdletBinding()]
param(
    [string]$ConfigPath = (Join-Path ([Environment]::GetFolderPath('LocalApplicationData')) 'DevSpaceChatGPT\operator-config.json')
)
...
& (Join-Path $PSScriptRoot 'Start-DevSpaceChatGPT.ps1') `
